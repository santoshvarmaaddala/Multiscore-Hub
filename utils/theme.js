...
export const lightTheme = {
  ...
  tabBarActiveTintColor: '#007bff', // Blue for active tab
...
export const darkTheme = {
  ...
  tabBarActiveTintColor: '#bb86fc', // Purple for active tab in dark mode
  tabBarInactiveTintColor: '#a0a0a0', // Light gray for inactive tabs
};